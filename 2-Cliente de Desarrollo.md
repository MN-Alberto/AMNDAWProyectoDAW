...
Para conectarnos mediante ssh con el usuario operadorweb, primero necesitaremos clicar en la opcion "Session".

![alt text](mobaXterm/1.png)

Aquí deberemos de clicar en la opción ssh y indicar la IP de nuestro servidor ademas del usuario con el que queremos conectarnos.

![alt text](mobaXterm/2.png)
